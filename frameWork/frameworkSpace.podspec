...
Pod::Spec.new do |spec|
 ...
 spec.ios.deployment_target = '8.0' # 支持的pod最低版本
  ...
  spec.vendored_frameworks = 'firstFrameWork/firstFrameWork.{framework}' # 放入封装好的.framework地址
  spec.resource     = 'firstFrameWork/firstBundel.bundle' # .bundle资源文件
  spec.source_files = 'firstFrameWork/firstFrameWork/template'     # 代码源文件地址，**/*表示Classes目录及其子目录下所有文件，如果有多个目录下则用逗号分开，如果需要在项目中分组显示，这里也要做相应的设置
  
spec.resource_bundles = {
    'PodTestLibrary' => ['firstFrameWorkf/irstFrameWork/Assets/*.png']
  }                                       #资源文件地址
